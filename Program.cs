...
{
    Console.WriteLine("Unable to parse the measure");
}
...
Console.WriteLine($"Message: {alphabetical}");
...
decimal decimalResult1 = value1 / value2;

int result1 = Convert.ToInt32(decimalResult1);

// Hint: You need to round the result to nearest integer (don't just truncate)
Console.WriteLine($"Divide value1 by value2, display the result as an int: {result1}");

decimal decimalValue3 = (decimal)value3;
decimal result2 = value2 / decimalValue3;
